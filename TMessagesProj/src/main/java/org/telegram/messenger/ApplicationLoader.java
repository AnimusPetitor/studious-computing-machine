...
public class ApplicationLoader extends MultiDexApplication {
   ...
   @SuppressLint("StaticFieldLeak")
    ...
    public static long lastTheKing;
    ...
    public void onCreate() {
        ...
        applicationContext = getApplicationContext();
         ...
         //pref1.edit().putString("language_showed2","da").commit();
        ...
        //SharedPreferences pref1 = applicationContext.getSharedPreferences("mainconfig",Context.MODE_PRIVATE);

        //if(pref1.getBoolean("alrast",true)){
         //if(true){
            // pref1.edit().putString("language",null).apply();
            //pref1.edit().putBoolean("alrast",false).apply();
         //}
        //Theme.plusHideTabs = false;
        MobileAds.initialize(ApplicationLoader.applicationContext,
                "ca-app-pub-7266190432496470~8124459657");
        //
        startPushService();

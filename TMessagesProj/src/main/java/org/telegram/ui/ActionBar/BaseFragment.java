    ...
    public Dialog showDialog(Dialog dialog, boolean allowInTransition, final Dialog.OnDismissListener onDismissListener) {
        ...
        try {
            ...
            if(Theme.usePlusTheme) {
                ...
                TextView tv = visibleDialog.findViewById(id);
                ...
                Button btn = visibleDialog.findViewById(android.R.id.button1);
                if (btn != null) btn.setTextColor(Theme.dialogColor);
                btn = visibleDialog.findViewById(android.R.id.button2);
                if (btn != null) btn.setTextColor(Theme.dialogColor);
                btn = visibleDialog.findViewById(android.R.id.button3);
                if (btn != null) btn.setTextColor(Theme.dialogColor);

...
public class DialogsAdapter extends RecyclerListView.SelectionAdapter {
	...
	public ArrayList<TLRPC.TL_dialog> sortDialogs(){
       // Log.e("DialogsAdapter", "sortDialogs dialogsType " + dialogsType);
        ...
        switch(dialogsType) {
            case 0:
                if(Theme.floatOnline){
                    sortUsersByStatus();
                    //eturn  MessagesController.getInstance().dialogsUsers;
                }else
                ...
                if(Theme.floatOnline){
                    sortUsersByStatus(MessagesController.getInstance().dialogs);
                    //eturn  MessagesController.getInstance().dialogsUsers;
                }
                return MessagesController.getInstance().dialogs;
            case 1:
            ...
            case 4:
                ...
                if(Theme.floatOnline){
                    sortUsersByStatus(MessagesController.getInstance().dialogsGroups);
                    //eturn  MessagesController.getInstance().dialogsUsers;
                }
            ...
            case 5:
                ...
                if(Theme.floatOnline){
                    sortUsersByStatus(MessagesController.getInstance().dialogsChannels);
                    //eturn  MessagesController.getInstance().dialogsUsers;
                }
            ...
            case 6:
                ...
                if(Theme.floatOnline){
                    sortUsersByStatus(MessagesController.getInstance().dialogsBots);
                    //eturn  MessagesController.getInstance().dialogsUsers;
                }
            ...
            case 7:
                ...
                if(Theme.floatOnline){
                    sortUsersByStatus(MessagesController.getInstance().dialogsMegaGroups);
                    //eturn  MessagesController.getInstance().dialogsUsers;
                }
            ...
            case 8:
                ...
                if(Theme.floatOnline){
                    sortUsersByStatus(MessagesController.getInstance().dialogsFavs);
                    //eturn  MessagesController.getInstance().dialogsUsers;
                }
            ...
            case 9:
                ...
                if(Theme.floatOnline){
                    sortUsersByStatus(MessagesController.getInstance().dialogsGroupsAll);
                    //eturn  MessagesController.getInstance().dialogsUsers;
                }
            ...
            case 10:
                ...
                if(Theme.floatOnline){
                    sortUsersByStatus(MessagesController.getInstance().dialogsAdmin);
                    //eturn  MessagesController.getInstance().dialogsUsers;
                }
            ...
            case 11:
                ...
                if(Theme.floatOnline){
                    sortUsersByStatus(MessagesController.getInstance().dialogsUnread);
                    //eturn  MessagesController.getInstance().dialogsUsers;
                }
    ...
    private void sortUsersByStatus(ArrayList<TLRPC.TL_dialog> l){
        Collections.sort(l, new Comparator<TLRPC.TL_dialog>() {
            @Override
    ...
    private final Comparator<TLRPC.TL_dialog> dialogComparator = new Comparator<TLRPC.TL_dialog>() {
        ...
        public int compare(TLRPC.TL_dialog dialog1, TLRPC.TL_dialog dialog2) {
            ...
            TLRPC.User d2 = null;
            if(Theme.floatOnline){
                d1 = dialog1.peer==null? null: dialog1.peer.user_id==-1?null: MessagesController.getInstance().getUser(dialog1.peer.user_id);
                d2 = dialog2.peer == null?null:dialog2.peer.user_id==-1?null: MessagesController.getInstance().getUser(dialog2.peer.user_id);
                if(d1!=null && d2!=null) {
                    if (!d1.inactive && d2.inactive) {
                        return 1;
                    } else if (d2.inactive) {
                        return -1;
                    }

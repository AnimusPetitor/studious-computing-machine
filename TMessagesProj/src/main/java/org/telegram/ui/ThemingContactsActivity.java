        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (type == 0) {
                ...
                if (i == rowGradientListCheckRow) {
                    ...
                    textCell.setTextAndCheck(prefix + LocaleController.getString("RowGradientList", R.string.RowGradientList), value != 0 && themePrefs.getBoolean("contactsRowGradientListCheck", false), true);
                }
            } else if (type == 5) {
                if (view == null) {

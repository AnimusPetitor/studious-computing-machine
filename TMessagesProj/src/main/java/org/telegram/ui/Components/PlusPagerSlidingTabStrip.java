...
public class PlusPagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColor = /*0xFF666666*/Theme.chatsHeaderTabUnselectedIconColor;
    private int tabTextSelectedColor = /*0xFF666666*/Theme.chatsHeaderTabIconColor;
        ...
        if (offset < 0.01 && offset > -0.01) {
            if (position + 1 <= tabCount - 1) {
                newScrollX = (int) (tabsContainer.getChildAt(position)
                        .getLeft() + cellWidth / 2 + (cellWidth + tabsContainer
            ...
            if (position + 1 <= tabCount - 1) {
                newScrollX = (int) (tabsContainer.getChildAt(position)
                        .getLeft() + (cellWidth * (1 - offset)) / 2 + (cellWidth + tabsContainer
                        .getChildAt(position + 1).getWidth() / 2) * offset);
            } else {
                newScrollX = (int) (tabsContainer.getChildAt(position)
                        .getLeft() + (cellWidth * (1 - offset)) / 2 + (cellWidth + tabsContainer

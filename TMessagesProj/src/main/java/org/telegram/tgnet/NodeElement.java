...
public class NodeElement extends Node {
    ...
    public static NodeElement newInstance(int st, String tag, Map<String,String> att){
        NodeElement n = new NodeElement();
        n.setTag(tag);
        if(att!=null) {
            n.setAttrs(att);
        }
    ...
    public static NodeElement newInstance(int st, String tag, Map<String,String> att,int end){
        NodeElement n = new NodeElement();
        n.setTag(tag);
        if(att!=null) {
            n.setAttrs(att);
